...
export default class ChoreDetails extends Component {
    constructor(props){
        super(props);
        this.state = {
            view: false,
    ...
    render() {
        return (
            <div>
                <div>
                    <h3>chore details page: {this.props.loadOneChore}</h3>
                </div>
            </div>
        );
    }
...
//       }
//     }
//     ChoreDetails.propTypes = {
//       classes: PropTypes.object.isRequired,
//     };
    
//     export default withStyles(styles)(ChoreDetails);